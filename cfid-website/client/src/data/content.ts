...
export const zhContent: ContentData = {
  ...
  about: {
    ...
    paragraphs: [
      "中林国际（China Forestry International Development Limited，以下简称\"中林\"），于2017年创立于\"非洲明珠\"乌干达，是东非农林行业的领军企业。作为一家集种植、加工与贸易于一体的综合性农林企业，中林已在乌干达、坦桑尼亚、莫桑比克设立分支机构，业务覆盖经济林种植、林化产品采集及深加工、人造板制造、咖啡种植加工与贸易等多个领域，产品及服务面向全球市场。",
      "中林致力于通过科学化管理与人性化关怀相结合的方式，构建持久的组织竞争力。依托非洲丰富的自然资源与人力资源优势，中林已迅速成长为区域内农林行业的标杆企业。",
      "在人才发展方面，中林秉持以人为本的理念，为优秀的奋斗者搭建实现个人价值与财富增长的平台。同时，积极响应\"一带一路\"倡议，持续为当地创造高质量就业机会，切实履行企业社会责任。",
    ],
    stats: [
      { value: "2017", label: "创立年份" },
      { value: "9,000+", label: "员工规模" },
