            ...
            <div className="bg-gradient-to-br from-cream to-cream-dark rounded-sm overflow-hidden border border-border/30 h-80 lg:h-full min-h-[360px] relative">
              ...
              <div className="absolute inset-0">
                <div className="absolute inset-0 opacity-70">
                  <div className="absolute left-[8%] top-[15%] w-[110%] h-px bg-forest/10 rotate-[18deg]" />
                  <div className="absolute left-[-6%] top-[38%] w-[110%] h-px bg-forest/10 rotate-[-8deg]" />
                  <div className="absolute left-[4%] top-[62%] w-[110%] h-px bg-forest/10 rotate-[10deg]" />
                  <div className="absolute left-[25%] top-[-10%] w-px h-[130%] bg-forest/10 rotate-[12deg]" />
                  <div className="absolute left-[52%] top-[-10%] w-px h-[130%] bg-forest/10 rotate-[-10deg]" />
                  <div className="absolute left-[78%] top-[-10%] w-px h-[130%] bg-forest/10 rotate-[8deg]" />
                </div>
                ...
                <div className="absolute left-6 right-6 bottom-6 bg-white/92 backdrop-blur-sm border border-border/40 p-5 rounded-sm">
                  <p
                    className="text-foreground font-medium text-sm md:text-base leading-relaxed mb-3"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {lang === "zh"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 text-sm font-medium text-forest hover:text-copper transition-colors"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    <span>
                      {lang === "zh" ? "查看高德地图" : "Open in Amap"}
                    </span>
