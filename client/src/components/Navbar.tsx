    ...
    <>
      ...
      >
        <div className="container flex items-center justify-between h-20">
          ...
          >
            <div className={`flex flex-col transition-colors duration-500 ${scrolled ? "text-forest" : "text-white"}`}>
              <span className="text-xl font-bold tracking-wider" style={{ fontFamily: "var(--font-display)" }}>
                {lang === "zh" ? "中林国际" : "CFID"}
              </span>
              <div className="flex items-center gap-2">
                <div className={`w-5 h-[1px] transition-colors duration-500 ${scrolled ? "bg-copper" : "bg-copper-light"}`} />
                <span className="text-[9px] tracking-[0.2em] opacity-60 uppercase" style={{ fontFamily: "var(--font-body)" }}>
