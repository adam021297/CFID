...
export default function OperationsSection() {
  ...
  return (
    <section id="operations" className="py-24 md:py-32 relative overflow-hidden" ref={ref}>
      {/* Top organic curve transition */}
      <div className="absolute top-0 left-0 right-0 -translate-y-[1px]">
        <svg viewBox="0 0 1440 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full" preserveAspectRatio="none">
          <path d="M0,0 L1440,0 L1440,40 Q1080,80 720,50 Q360,20 0,60 Z" fill="oklch(0.98 0.005 80)" />
        </svg>
      </div>
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <p className="text-foreground/55 text-sm md:text-base leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
