...
export interface ContentData {
  ...
  operations: {
    ...
    scale: {
      sectionTitle: string;
      sectionTitleEn: string;
      items: { title: string; metrics: string[]; description?: string }[];
    };
  };
  careers: {
    sectionTitle: string;
...
export const zhContent: ContentData = {
  ...
  operations: {
    ...
    scale: {
      sectionTitle: "产业数据",
      sectionTitleEn: "INDUSTRIAL SCALE",
      items: [
        {
          title: "经济林种植",
          metrics: [
            "自有自种经济林约 60,000 亩",
            "未来10年内，每年计划种植 15,000-30,000 亩",
            "种植经济林总规模达 300,000 亩以上",
          ],
          description:
            "在林业资源使用上，兼顾林业化工产业和木材加工的协同有序发展，并在种植、维护、采伐、加工利用等环节以科学管理降低成本，使资源效益最大化。",
        },
        {
          title: "林化产业",
          metrics: [
            "脂松香：年产约 26,000 吨，加勒比松香为主",
            "松节油：加勒比松松节油、湿加松松节油为主，年产约 5,000 吨",
          ],
        },
        {
          title: "人造板产业",
          metrics: [
            "胶合板：高端饰面薄板、包装板、工程模板，年产量 20 万立方",
            "中纤板：生产线筹建中，设计年产 20 万立方",
          ],
        },
      ],
    },
...
export const enContent: ContentData = {
  ...
  operations: {
    ...
    scale: {
      sectionTitle: "Industrial Data",
      sectionTitleEn: "INDUSTRIAL SCALE",
      items: [
        {
          title: "Commercial Forest Plantations",
          metrics: [
            "Approx. 60,000 mu of self-owned and self-planted commercial forests",
            "Planned annual planting of 15,000-30,000 mu over the next 10 years",
            "Planned total commercial forest scale above 300,000 mu",
          ],
          description:
            "Across planting, maintenance, harvesting, processing, and utilization, CFID applies scientific management to lower costs, maximize resource value, and coordinate forest chemical and timber processing development.",
        },
        {
          title: "Forest Chemicals",
          metrics: [
            "Rosin: approx. 26,000 tons annually, mainly Caribbean pine rosin",
            "Turpentine: approx. 5,000 tons annually, mainly Caribbean pine and slash pine turpentine",
          ],
        },
        {
          title: "Engineered Wood Panels",
          metrics: [
            "Plywood: premium decorative thin panels, packaging panels, and formwork, with annual output of 200,000 m³",
            "MDF: production line under preparation, designed annual capacity of 200,000 m³",
          ],
        },
      ],
    },
