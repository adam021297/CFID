    ...
    items: [
      {
        ...
        title: "经济林种植",
        description:
          "坚持可持续、可循环的林业经营理念，自有自种经济林约 60,000 亩，未来10年计划每年种植 15,000-30,000 亩，总规模达 300,000 亩以上。通过科学规划与精细化管理，实现林产资源的自给自足，并兼顾林化产业和木材加工的协同发展。",
        image:
      ...
      },
      {
        ...
        title: "咖啡种植与贸易",
        description:
          "立足东非咖啡种植黄金带，推行高标准种植、生态化培育与产业化运营，从源头保障咖啡品质，为精深加工和大宗商品贸易提供稳定的原料供应，是公司面向东非特色农产品延伸的重要业务。",
        image:
      ...
      },
      {
        ...
        title: "林化产业",
        description:
          "中林所用松脂均由自有团队在自有或合作林场中科学采割，从源头把控品质。脂松香年产约 26,000 吨，以加勒比松香为主；松节油年产约 5,000 吨，以加勒比松松节油、湿加松松节油为主。",
        image:
      ...
      },
      {
        ...
        title: "人造板制造",
        description:
          "以优质木材及非木质植物纤维为原料，经现代化生产线精密加工，生产高端饰面薄板、包装板、工程模板等胶合板产品，年产量 20 万立方；中纤板生产线筹建中，设计年产 20 万立方。",
        image:
    ...
    items: [
      {
        ...
        description:
          "Committed to sustainable and circular forestry practices, CFID operates approx. 60,000 mu of self-owned and self-planted commercial forests, with planned annual planting of 15,000-30,000 mu over the next 10 years and a target total scale above 300,000 mu.",
        image:
          "https://d2xsxph8kpxj0f.cloudfront.net/310519663507257093/T5tGXvARSyoxmqcg5LybPU/forest-plantation-nKJYujtFKCjk4QjhZkfRbK.webp",
      },
      {
        ...
        description:
          "Situated within East Africa's prime coffee-growing belt, we promote high-standard cultivation, ecologically sound practices, and an integrated industrial approach, ensuring reliable upstream supply for coffee processing and commodity trading while extending CFID's agricultural product portfolio.",
        image:
          "https://d2xsxph8kpxj0f.cloudfront.net/310519663507257093/T5tGXvARSyoxmqcg5LybPU/coffee-plantation-AgiRi3pjb4xPHJqcfAaYMu.webp",
      },
      {
        ...
        description:
          "All pine resin processed by CFID is scientifically tapped by our in-house teams from company-owned or cooperative plantations. Annual output reaches approx. 26,000 tons of rosin, mainly Caribbean pine rosin, and approx. 5,000 tons of turpentine.",
        image:
          "https://d2xsxph8kpxj0f.cloudfront.net/310519663507257093/T5tGXvARSyoxmqcg5LybPU/pine-resin-oUPGUYkPg7y9RHhFYVzu6q.webp",
      },
      {
        ...
        description:
          "Using premium timber and non-wood plant fibers as raw materials, our modern production lines manufacture premium decorative thin plywood, packaging panels, and formwork, with annual plywood output of 200,000 m³. An MDF line is under preparation with designed annual capacity of 200,000 m³.",
        image:
          "https://d2xsxph8kpxj0f.cloudfront.net/310519663507257093/T5tGXvARSyoxmqcg5LybPU/wood-panel-factory-6z7incH54pY5WB3eWS5jZq.webp",
      },
    ],
