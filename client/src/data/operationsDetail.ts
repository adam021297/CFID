...
export const zhOperationDetails: Record<string, OperationDetail> = {
  plantation: {
    ...
    introduction: [
      "中林国际坚持可持续、可循环的林业经营理念，在乌干达、坦桑尼亚和莫桑比克建立了大规模经济林种植基地，自有自种经济林约 60,000 亩。未来10年内，公司计划每年种植 15,000-30,000 亩，推动经济林总规模达到 300,000 亩以上。",
      "专注于农林行业，坚持走可持续发展路线，建立从种植、碳减排、原料加工、成品制造的全产业链闭环；将地球上最珍贵的可再生资源——树木的生态价值及经济价值最大化。",
      "中林的种植基地覆盖多种经济树种，包括松树、桉树等速生林木，为下游林化产品和人造板制造提供充足、优质的原材料保障。在种植、维护、采伐、加工利用等环节，公司通过科学管理降低成本，使资源效益最大化。",
    ],
    highlights: [
      {
        icon: "leaf",
    ...
    processSteps: [
      {
        step: "01",
        title: "选地规划",
        description: "科学评估土壤、气候条件，选择最适宜的种植区域与树种。",
      },
      {
        step: "02",
        title: "育苗培育",
        description: "建立标准化苗圃基地，培育优质种苗，确保成活率与生长速度。",
      },
      {
        step: "03",
        title: "科学种植",
        description: "采用现代化种植技术，合理密植，配合水肥一体化管理。",
      },
      {
        step: "04",
        title: "抚育管理",
        description: "定期巡护、病虫害防治、间伐修枝，保障林木健康生长。",
      },
      {
        step: "05",
        title: "可持续采伐",
        description:
          "按照轮伐周期科学采伐，同步开展迹地更新，实现资源永续利用。",
      },
    ],
    stats: [
      { value: "3", label: "种植国家" },
    ...
    features: [
      {
        title: "全产业链闭环",
        description:
          "种植基地直接为下游林化产品和人造板制造提供原材料，实现从种植到成品的完整产业链闭环。",
      },
      {
        title: "生态与经济并重",
        description:
          "在追求经济效益的同时，注重生态环境保护，实现绿色可持续发展。",
      },
      {
        title: "科学化管理",
        description:
          "引入现代林业管理技术，建立标准化的种植、抚育和采伐流程，提升林地产出效率。",
      },
    ],
  },
    ...
    processSteps: [
      {
        ...
        title: "精选种植",
        description:
          "选择优质阿拉比卡和罗布斯塔品种，在最适宜的海拔和土壤条件下种植。",
      },
      {
        step: "02",
        title: "生态培育",
        description:
          "采用遮荫种植、有机肥料等生态化培育方式，保障咖啡豆的风味与品质。",
      },
      {
        step: "03",
        title: "精细采摘",
        description: "在最佳成熟期手工采摘咖啡鲜果，确保每一颗咖啡豆的品质。",
      },
      {
        step: "04",
        title: "标准加工",
        description:
          "采用水洗法和日晒法等标准化加工流程，从生豆到熟豆的精细处理。",
      },
      {
        step: "05",
        title: "品质贸易",
        description:
          "严格的品控体系保障出口品质，面向全球市场开展大宗商品贸易。",
      },
    ],
    stats: [
    ...
    features: [
      {
        title: "第二增长曲线",
        description:
          "咖啡产业是中林2024年开启的全新业务板块，被视为公司未来发展的重要增长引擎。",
      },
      {
        title: "双品种布局",
        description:
          "同时布局阿拉比卡和罗布斯塔两大品种，满足不同市场和客户的多元化需求。",
      },
      {
        title: "产地直供",
        description:
          "从东非产地直接供应全球市场，减少中间环节，确保品质和价格竞争力。",
      },
    ],
  },
  ...
  forestchemicals: {
    ...
    introduction: [
      ...
      "中林建立了从林地管理、松脂采集到精深加工的完整产业链，通过标准化的生产流程和严格的质量控制，生产高品质的松香、松节油等林化产品。其中，脂松香年产约 26,000 吨，以加勒比松香为主；松节油年产约 5,000 吨，以加勒比松松节油、湿加松松节油为主。",
    ],
    highlights: [
      {
        icon: "droplets",
      ...
      },
      {
        icon: "shield",
        title: "品质保障",
        description: "建立严格的质量管理体系，从采集到成品全流程品质可追溯。",
      },
    ],
    processSteps: [
      {
        ...
        title: "林地管理",
        description:
          "对自有和合作林场进行科学管理，确保松树健康生长，提高产脂量。",
      },
      {
        step: "02",
        title: "科学采割",
        description:
          "由专业团队按照标准化流程进行松脂采割，确保采集效率和树木健康。",
      },
      {
        step: "03",
        title: "原料收集",
        description: "建立高效的原料收集和运输网络，确保松脂新鲜度和品质。",
      },
      {
        step: "04",
        title: "精炼加工",
        description: "采用先进的蒸馏和精炼技术，将松脂加工为松香和松节油。",
      },
      {
        step: "05",
        title: "产品销售",
        description: "高品质林化产品面向全球化工、医药、食品等行业客户销售。",
      },
    ],
    stats: [
    ...
    features: [
      {
        title: "自有资源优势",
        description:
          "依托自有和合作林场的丰富松林资源，确保原材料的稳定供应和品质可控。",
      },
      {
        title: "可再生天然资源",
        description:
          "松脂是可再生的天然资源，林化产业的发展符合绿色可持续发展理念。",
      },
      {
        title: "高附加值产品",
        description:
          "通过精深加工将初级松脂转化为高附加值的松香、松节油等产品，提升产业价值。",
      },
    ],
  },
  ...
  panels: {
    ...
    introduction: [
      ...
      "中林的人造板制造业务依托自有种植基地的优质原材料供应，配备先进的生产设备和工艺技术。胶合板产品包括高端饰面薄板、包装板、工程模板，年产量约 20 万立方；中纤板生产线筹建中，设计年产 20 万立方。",
    ],
    highlights: [
      {
        icon: "layers",
        title: "多品类产品",
        description:
          "生产高品质胶合板，并推进中纤板生产线建设，满足建筑、家具、装饰等不同领域需求。",
      },
      {
        icon: "cog",
        title: "现代化产线",
    ...
    processSteps: [
      {
        step: "01",
        title: "原料备料",
        description: "从自有种植基地获取优质木材，经剥皮、切削等工序制备原料。",
      },
      {
        step: "02",
        title: "单元制备",
        description: "将原料加工为单板、纤维等不同规格的单元材料。",
      },
      {
        step: "03",
        title: "施胶组坯",
        description: "按照产品配方施加胶粘剂和添加剂，进行组坯铺装。",
      },
      {
        step: "04",
        title: "热压成型",
        description: "通过高温高压热压工艺，将组坯压制成型为板材。",
      },
      {
        step: "05",
        title: "精加工",
        description: "经砂光、裁边、质检等精加工工序，确保成品质量达标。",
      },
    ],
    stats: [
      { value: "多品类", label: "产品线" },
    ...
    features: [
      {
        title: "原料自给优势",
        description:
          "依托自有种植基地的充足原材料供应，有效降低生产成本，保障供应链稳定。",
      },
      {
        title: "全产业链协同",
        description:
          "与上游种植基地和林化产业形成协同效应，实现资源的高效利用和价值最大化。",
      },
      {
        title: "市场覆盖广泛",
        description:
          "产品广泛应用于建筑、家具和室内装饰三大领域，服务东非及全球市场客户。",
      },
    ],
  },
};
...
export const enOperationDetails: Record<string, OperationDetail> = {
  plantation: {
    ...
    heroImage:
      "https://d2xsxph8kpxj0f.cloudfront.net/310519663507257093/T5tGXvARSyoxmqcg5LybPU/forest-plantation-nKJYujtFKCjk4QjhZkfRbK.webp",
    introduction: [
      "CFID is committed to sustainable and circular forestry practices, having established large-scale commercial forest plantations across Uganda, Tanzania, and Mozambique. The company operates approx. 60,000 mu of self-owned and self-planted commercial forests, with planned annual planting of 15,000-30,000 mu over the next 10 years and a target total scale above 300,000 mu.",
      ...
      "Our plantations encompass multiple commercial tree species, including pine and eucalyptus fast-growing timber, providing a stable and high-quality raw material supply for downstream forest chemicals and engineered wood panel manufacturing. Across planting, maintenance, harvesting, processing, and utilization, CFID applies scientific management to lower costs and maximize resource value.",
    ],
    highlights: [
      {
        icon: "leaf",
    ...
    processSteps: [
      {
        ...
        description:
          "Scientific assessment of soil and climate conditions to identify optimal planting zones and species.",
      },
      {
        step: "02",
        title: "Nursery Cultivation",
        description:
          "Standardized nursery operations to cultivate premium seedlings with high survival and growth rates.",
      },
      {
        step: "03",
        title: "Precision Planting",
        description:
          "Modern planting techniques with optimized spacing and integrated water-fertilizer management.",
      },
      {
        step: "04",
        title: "Forest Tending",
        description:
          "Regular patrols, pest management, and selective thinning to ensure healthy tree growth.",
      },
      {
        step: "05",
        title: "Sustainable Harvesting",
        description:
          "Scientific harvesting on rotation cycles with concurrent site regeneration for perpetual resource use.",
      },
    ],
    stats: [
    ...
    features: [
      {
        title: "Closed-Loop Value Chain",
        description:
          "Plantation bases directly supply raw materials for downstream forest chemicals and panel manufacturing, creating a complete industrial chain.",
      },
      {
        title: "Ecology Meets Economy",
        description:
          "Pursuing economic returns while prioritizing environmental stewardship for truly sustainable green development.",
      },
      {
        title: "Scientific Management",
        description:
          "Adopting modern forestry management technologies with standardized planting, tending, and harvesting processes to maximize land productivity.",
      },
    ],
  },
  ...
  coffee: {
    ...
    processSteps: [
      {
        step: "01",
        title: "Selective Planting",
        description:
          "Choosing premium Arabica and Robusta varieties planted at optimal altitudes and soil conditions.",
      },
      {
        step: "02",
        title: "Ecological Cultivation",
        description:
          "Shade-grown methods and organic fertilization to preserve flavor profiles and bean quality.",
      },
      {
        step: "03",
        title: "Precision Harvesting",
        description:
          "Hand-picking coffee cherries at peak ripeness to ensure every bean meets quality standards.",
      },
      {
        step: "04",
        title: "Standard Processing",
        description:
          "Washed and natural processing methods for meticulous treatment from green to roasted beans.",
      },
      {
        step: "05",
        title: "Quality Trading",
        description:
          "Rigorous quality control systems ensuring export-grade quality for global commodity markets.",
      },
    ],
    stats: [
    ...
    features: [
      {
        title: "Second Growth Engine",
        description:
          "The coffee division, launched in 2024, represents a strategic new business pillar and a key driver of future growth.",
      },
      {
        title: "Dual-Variety Strategy",
        description:
          "Cultivating both Arabica and Robusta to serve diverse market segments and customer requirements.",
      },
      {
        title: "Origin-Direct Supply",
        description:
          "Supplying global markets directly from East African origins, reducing intermediaries to ensure quality and price competitiveness.",
      },
    ],
  },
  ...
  forestchemicals: {
    ...
    introduction: [
      ...
      "CFID has established a complete value chain from forest management and resin collection to deep processing. Through standardized production and rigorous quality control, annual output reaches approx. 26,000 tons of rosin, mainly Caribbean pine rosin, and approx. 5,000 tons of turpentine, mainly Caribbean pine and slash pine turpentine.",
    ],
    highlights: [
      {
        icon: "droplets",
    ...
    processSteps: [
      {
        ...
        description:
          "Scientific management of company-owned and cooperative forests to ensure healthy tree growth and optimal resin yield.",
      },
      {
        step: "02",
        title: "Scientific Tapping",
        description:
          "Professional teams follow standardized procedures for efficient resin collection while maintaining tree health.",
      },
      {
        step: "03",
        title: "Raw Material Collection",
        description:
          "An efficient collection and transportation network ensures resin freshness and quality.",
      },
      {
        step: "04",
        title: "Refining & Processing",
        description:
          "Advanced distillation and refining technologies transform raw resin into rosin and turpentine.",
      },
      {
        step: "05",
        title: "Product Distribution",
        description:
          "Premium forest chemical products are distributed to global clients in chemicals, pharmaceuticals, and food industries.",
      },
    ],
    stats: [
    ...
    features: [
      {
        title: "Proprietary Resource Advantage",
        description:
          "Leveraging abundant pine forest resources from owned and cooperative plantations to ensure stable supply and quality control.",
      },
      {
        title: "Renewable Natural Resource",
        description:
          "Pine resin is a renewable natural resource, aligning the forest chemicals business with green and sustainable development principles.",
      },
      {
        title: "High Value-Added Products",
        description:
          "Deep processing transforms raw resin into high value-added rosin, turpentine, and derivatives, elevating the industry's value contribution.",
      },
    ],
  },
  ...
  panels: {
    ...
    introduction: [
      ...
      "CFID's panel manufacturing operations draw on high-quality raw materials from our own plantations, equipped with advanced production equipment and process technologies. Plywood products include premium decorative thin panels, packaging panels, and formwork, with annual output of approx. 200,000 m³. An MDF line is under preparation with designed annual capacity of 200,000 m³.",
    ],
    highlights: [
      {
        icon: "layers",
        ...
        description:
          "Manufacturing high-quality plywood while advancing MDF production capacity to serve construction, furniture, and interior design sectors.",
      },
      {
        icon: "cog",
    ...
    processSteps: [
      {
        ...
        description:
          "Sourcing premium timber from our own plantations, processed through debarking and chipping.",
      },
      {
        step: "02",
        title: "Unit Preparation",
        description:
          "Processing raw materials into veneers or fibers of various specifications.",
      },
      {
        step: "03",
        title: "Gluing & Assembly",
        description:
          "Applying adhesives and additives per product formulations, then assembling mat formations.",
      },
      {
        step: "04",
        title: "Hot Pressing",
        description:
          "High-temperature, high-pressure pressing to form assembled mats into finished boards.",
      },
      {
        step: "05",
        title: "Finishing",
        description:
          "Sanding, trimming, and quality inspection to ensure finished products meet specifications.",
      },
    ],
    stats: [
    ...
    features: [
      {
        title: "Raw Material Self-Sufficiency",
        description:
          "Drawing on ample raw material supply from our own plantations to effectively reduce costs and ensure supply chain stability.",
      },
      {
        title: "Full Value Chain Synergy",
        description:
          "Creating synergies with upstream plantations and forest chemicals operations for efficient resource utilization and value maximization.",
      },
      {
        title: "Broad Market Coverage",
        description:
          "Products serve the construction, furniture, and interior design sectors across East Africa and global markets.",
      },
    ],
  },
};
